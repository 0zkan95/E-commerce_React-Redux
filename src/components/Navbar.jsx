    ...
    <>
      ...
      <div className='flex justify-around items-center'>
        ...
        <div className='flex flex-row items-center'>
          <button className='text-white font-inter text-base font-medium tracking-normal leading-none text-center mr-4'>
            Log out
          </button>
          <div className='flex flex-row items-center'>
            <svg
            ...
            <p className='text-white font-inter text-base font-medium tracking-normal leading-none text-center mr-2'>Wish List</p>
          </div>
          <div
            className='flex flex-row items-center cursor-pointer'
            onClick={handleOpen}
          >
            {totalAmount > 0 ? <span className='rounded-full bg-grat-300 text-red-500 border-red-500 px-2 font-inter text-sm mr-1'>{totalAmount}</span> :
              <svg
                xmlns="http://www.w3.org/2000/svg"
